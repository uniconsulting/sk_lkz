  ...
  return (
    <main className="mx-auto w-full max-w-[1440px] px-4 pb-16 pt-6 md:px-6 md:pt-10">
      <div className="glass rounded-block p-6">
        <h1 className="text-[26px] font-semibold tracking-[-0.02em] text-ink md:text-[34px]">Документы</h1>
        <p className="mt-2 text-[13px] text-ink/70">Заглушка страницы. В прототипе документы открываются с главной.</p>
        <div className="mt-5">
          <Link
            href="/"
